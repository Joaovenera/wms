...
export const insertPalletSchema = z.object({
  ...
  length: z.number().int().positive("Comprimento deve ser positivo"),
...
export const insertVehicleSchema = z.object({
  ...
  cargoAreaLength: z.number().positive("Comprimento da área de carga deve ser positivo"),
  cargoAreaWidth: z.number().positive("Largura da área de carga deve ser positiva"),
  cargoAreaHeight: z.number().positive("Altura da área de carga deve ser positiva"),
  status: z.string().default("disponivel"),
  observations: z.string().optional(),
  isActive: z.boolean().default(true),
  createdBy: z.number(),
